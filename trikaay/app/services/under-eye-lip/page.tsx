  ...
  return (
    <main className="min-h-screen gradient-bg py-0">
      ...
      <section className="container-custom bg-white/90 rounded-3xl shadow-xl px-6 py-10 md:py-16 md:px-16 -mt-10 relative z-10 mb-12">
        <h2 className="text-2xl md:text-3xl font-semibold font-playfair mb-4 text-[var(--primary-color)]">What Are Under Eye & Lip Treatments?</h2>
        ...
        <h2 className="text-2xl md:text-3xl font-semibold font-playfair mb-4 text-[var(--primary-color)]">Why Choose Trikaay for Under Eye & Lip Care?</h2>
